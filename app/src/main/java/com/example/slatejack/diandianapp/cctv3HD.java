...
public class cctv3HD extends AppCompatActivity {
    private  SimpleExoPlayer player;
    PlayerView playerView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate( savedInstanceState );
        setContentView( R.layout.activity_cctv3_hd );
        playerView=findViewById( R.id.player_view4 );
        //得到默认合适的带宽
        ...
        Uri uri=Uri.parse( "http://223.110.245.170/ott.js.chinamobile.com/PLTV/3/224/3221225588/index.m3u8" );
